<template>
  <v-col>
    <v-row>
      <v-form>Wybierz statystykę:
        <v-select class="d-flex justify-center"
                  label="Temat zajęć" v-model="selected"
        ...
        for (var x2 = 0; x2 < this.grades.length; x2++) {
          if(this.grades[x2].name==this.selected){
            for(var y=0;y<this.grades[x2].grades.length;y++){
              if(!this.inArray(owoce,this.grades[x2].grades[y].grade)&&!(this.grades[x2].grades[y].grade===null)){
        ...
        for (var x2 = 0; x2 < this.grades.length; x2++) {
          if(this.grades[x2].name==this.selected){
            for(var y3=0;y3<this.grades[x2].grades.length;y3++){
              if(!this.inArray(owoce2,this.grades[x2].grades[y3].grade)&&!(this.grades[x2].grades[y3].grade===null)){
          ...
          if(this.grades[x3].name==this.selected){
            for(var y2=0;y2<this.grades[x3].grades.length;y2++){
              if(!(this.grades[x3].grades[y2].grade===null)){
                ...
                owoce[this.findLocation(owoce2,this.grades[x3].grades[y2].grade)]+=1;
